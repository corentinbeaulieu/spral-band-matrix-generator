! examples/Fortran/random_band_matrix.f90 - Example code for SPRAL_RANDOM_MATRIX pkg
program random_matrix_example
   ...
   integer, parameter :: m=4, n=5, nnz=8, bw=1
   ...
   write(*, "(a,i3,a,i3,a,i3,a)") &
      ...
      " non-zeroes"
   call random_matrix_generate(state, 0, m, n, nnz, bw, ptr, row, flag,     &
        val=val, nonsingular=.true.)
